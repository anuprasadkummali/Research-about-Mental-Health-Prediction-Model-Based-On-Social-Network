...
# select input
sql = 'SELECT `COL 1`, `COL 2`, `COL 3`, `COL 4`, `COL 49`, `COL 78` FROM `OSQ`;';
cursor.execute(sql);
...
average1 = 3731/3814; #010a 2
average1 = round(average1, 8);
average2 = 3496/3812; #010b 3
average2 = round(average2, 8);
average3 = 3734/3811; #010c 4
average3 = round(average3, 8);
average4 = 2890/3812; #080 49
average4 = round(average4, 8);
average5 = 3481/3803; #060 78
...
sql = 'ALTER TABLE `features_list` ADD `F85` VARCHAR(10) NOT NULL;';
cursor.execute(sql);

# store into correct table in DB
query = 'UPDATE `features_list` SET `F85` = %s WHERE `QN` = %s;'
for i in range(1, size):
