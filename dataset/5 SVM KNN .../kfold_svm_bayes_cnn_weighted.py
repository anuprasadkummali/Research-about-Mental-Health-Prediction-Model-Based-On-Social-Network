...
for train_index, test_index in kf.split(X):
    ...
    score_svm = precision_recall_fscore_support(y_test, y_pred_svm, beta=1.0, labels=None, pos_label=1, average='weighted',
                                            warn_for=('precision', 'recall', 'f-score'), sample_weight=None);
    report_svm = classification_report(y_test,y_pred_svm);
    # print(score);
    score2_svm = precision_recall_fscore_support(y2_test, y2_pred_svm, beta=1.0, average='weighted', pos_label=None,
                                             warn_for=('precision', 'recall', 'f-score'), sample_weight=None);
    ...
    # print(score);
    score2_gnb = precision_recall_fscore_support(y2_test, y2_pred_gnb, beta=1.0, average='weighted', pos_label=None,
                                                 warn_for=('precision', 'recall', 'f-score'), sample_weight=None);
    ...
    # print(score);
    score2_knn = precision_recall_fscore_support(y2_test, y2_pred_knn, beta=1.0, average='weighted', pos_label=None,
                                                 warn_for=('precision', 'recall', 'f-score'), sample_weight=None);
    ...
    # print(score);
    score2_dtree = precision_recall_fscore_support(y2_test, y2_pred_dtree, beta=1.0, average='weighted', pos_label=None,
                                                 warn_for=('precision', 'recall', 'f-score'), sample_weight=None);
